...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      // 销售管理
      { path: '/sales/customer-order', name: 'SalesCustomerOrder', component: () => import('@/views/sales/CustomerOrder.vue'), meta: { title: '客户订货单' } },
      ...
      { path: '/finance/transfer', name: 'FinanceTransfer', component: () => import('@/views/Placeholder.vue'), meta: { title: '收款单' } },
      { path: '/finance/gift', name: 'FinanceGift', component: () => import('@/views/Placeholder.vue'), meta: { title: '预收款单' } },
