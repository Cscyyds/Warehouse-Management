...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: '/system/dict', name: 'Dict', component: () => import('@/views/Placeholder.vue'), meta: { title: '字典管理' } },
      { path: '/system/area', name: 'Area', component: () => import('@/views/Placeholder.vue'), meta: { title: '行政区划' } },
      { path: '/system/logs', name: 'Logs', component: () => import('@/views/Placeholder.vue'), meta: { title: '访问日志' } },
      { path: '/system/online', name: 'Online', component: () => import('@/views/Placeholder.vue'), meta: { title: '在线用户' } },
      { path: '/system/msg-pending', name: 'MsgPending', component: () => import('@/views/Placeholder.vue'), meta: { title: '未完成消息' } },
      { path: '/system/msg-done', name: 'MsgDone', component: () => import('@/views/Placeholder.vue'), meta: { title: '已完成消息' } },
      { path: '/system/msg-template', name: 'MsgTemplate', component: () => import('@/views/Placeholder.vue'), meta: { title: '消息模板管理' } },
      // 客户管理
