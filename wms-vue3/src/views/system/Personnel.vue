...
<style scoped>
.personnel-page { display: flex; gap: 16px; height: 100%; padding: 4px; background: #f0f2f5; border-radius: var(--radius-lg); }
...
/* ── 用户面板 ── */
.user-panel { flex: 1; background: #fff; border-radius: var(--radius-md); box-shadow: var(--shadow-sm); display: flex; flex-direction: column; padding: 16px; overflow: hidden; }
...
.personnel-page :deep(.el-table th.el-table__cell) { background: #fafafa; color: #4b5563; font-weight: 600; font-size: 13px; border-bottom: 1px solid #e5e7eb; }
.personnel-page :deep(.el-table td.el-table__cell) { border-bottom: 1px solid #f3f4f6; }
.personnel-page :deep(.el-table .table-row:hover > td.el-table__cell) { background-color: #f0f4ff; }
.personnel-page :deep(.el-table__body tr.el-table__row--striped td.el-table__cell) { background: #fafafa; }
