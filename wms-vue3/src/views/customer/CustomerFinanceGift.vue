...
const fallbackData: CustomerBalanceItem[] = [
  { id: '1', customerId: '1', customerName: '广州百诺建材有限公司', customerCode: 'C001', balanceType: 'gift', totalAmount: 5000, frozenAmount: 0, availableAmount: 3000, usedAmount: 2000, currency: 'CNY', createTime: '2024-01-01', updateTime: '2026-04-20 09:00' },
  { id: '2', customerId: '2', customerName: '深圳鑫源五金贸易', customerCode: 'C002', balanceType: 'gift', totalAmount: 2000, frozenAmount: 0, availableAmount: 2000, usedAmount: 0, currency: 'CNY', createTime: '2024-01-01', updateTime: '2026-04-18 10:00' },
]

async function loadData() {
  try {
    const res = await getAccountBalanceList({ ...searchForm, page: pagination.page, pageSize: pagination.pageSize })
...
const exportColumns = [
  ...
  { key: 'totalAmount', label: '赠送总额' }, { key: 'usedAmount', label: '已使用金额' },
