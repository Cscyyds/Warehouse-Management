  ...
  <ListTemplate title="销售订单明细表" v-model:page="pagination.page" v-model:page-size="pagination.pageSize" :total="pagination.total" @page-change="loadData">
    ...
    <template #table>
      <el-table :data="tableData" stripe size="small" style="width:100%" row-class-name="table-row" show-summary :summary-method="getSummaries">
        ...
        <el-table-column prop="unitPrice" label="单价" width="70" align="center" />
        <el-table-column prop="discountRate" label="折扣率" width="70" align="center" />
        <el-table-column prop="totalPrice" label="销售金额" width="80" align="center" />
        <el-table-column prop="taxRate" label="税率" width="60" align="center" />
        <el-table-column prop="taxAmount" label="税额" width="60" align="center" />
        <el-table-column prop="isFrozen" label="冻结状态" width="80" align="center">
