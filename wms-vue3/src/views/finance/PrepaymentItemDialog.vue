<template>
  ...
  >
    <div v-loading="loading" class="item-dialog-body">
      ...
      <el-button v-perm="'POST /api/v1/tenant-finance/prepayment-orders/items/add'" type="primary" size="small" @click="handleAdd" style="margin-bottom:8px">
      ...
      <el-table :data="list" size="small" border style="width:100%" v-loading="loading">
        ...
        <el-table-column label="操作" :width="global_opt_width" fixed="right" align="center">
          <template #default="{ row }">
            <el-button v-perm="'POST /api/v1/tenant-finance/prepayment-orders/items/update'" link type="primary" size="small" @click="handleEdit(row)">编辑</el-button>
            <el-button v-perm="'POST /api/v1/tenant-finance/prepayment-orders/items/delete'" link type="danger" size="small" @click="handleDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
