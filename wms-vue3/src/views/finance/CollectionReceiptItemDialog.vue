<template>
  ...
  >
    <div v-loading="loading" class="item-dialog-body">
      ...
      <el-button v-perm="'POST /api/v1/tenant-finance/collection-receipts/items/add'" type="primary" size="small" @click="handleAddItems" style="margin-bottom:8px">
      ...
      <el-table :data="detail?.items || []" size="small" border style="width:100%">
        ...
        <el-table-column label="操作" :width="global_opt_width" fixed="right" align="center">
          <template #default="{ row }">
            <el-button v-perm="'POST /api/v1/tenant-finance/collection-receipts/items/update'" link type="primary" size="small" @click="handleEditItem(row)">编辑</el-button>
            <el-button v-perm="'POST /api/v1/tenant-finance/collection-receipts/items/delete'" link type="danger" size="small" @click="handleDeleteItem(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
