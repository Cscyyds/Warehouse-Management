...
/** 代理分发为 zip 包（exe + libs/x64/printer.sdk.dll + config.json），解压后双击 exe 运行 */
export const XP_AGENT_DOWNLOAD_URL = `${import.meta.env.BASE_URL}downloads/xprinter-agent-1.1.0.zip`
