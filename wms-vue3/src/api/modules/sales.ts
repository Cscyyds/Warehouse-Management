...
export function getCustomerOrderList(_params: any): Promise<ApiResponse<any>> { return get<any>(`${BASE}/list`, {}).then(() => ({ code: 200, message: 'stub', data: STUB_LIST } as any)) }
export function getCustomerOrderDetail(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function createCustomerOrder(_data: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function updateCustomerOrder(_id: string, _data: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function deleteCustomerOrder(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function auditCustomerOrder(_id: string, _s: string, _o: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }

export function getAfterSaleList(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: STUB_LIST } as any) }
export function getAfterSaleDetail(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function createAfterSale(_data: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function updateAfterSale(_id: string, _data: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function deleteAfterSale(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function auditAfterSale(_id: string, _s: string, _o: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }

export function getSalesReturnDetail(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function createSalesReturn(_data: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function updateSalesReturn(_id: string, _data: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }

export function getReconciliationList(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: STUB_LIST } as any) }
export function getReconciliationDetail(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function createReconciliation(_data: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function updateReconciliation(_id: string, _data: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: {} } as any) }
export function deleteReconciliation(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function confirmReconciliation(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }

export function getSalesReport(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }

export function getSalesOrderDetail(id: string) { return getSalesOrderDetailV2(id) }
export function createSalesOrder(data: any) { return createSalesOrderV2(data) }
export function updateSalesOrder(_id: string, data: any) { return updateSalesOrderV2(data) }

export interface SalesReturnItem { [k: string]: unknown }

export function getSalesReturnList(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: STUB_LIST } as any) }
export function deleteSalesReturn(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function auditSalesReturn(_id: string, _s: string, _o: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function sendSalesReturnToWarehouse(_id: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function warehouseReturnSalesReturn(_id: string, _reason: string): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }

export function getSalesCustomerReport(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function getSalesOrderReport(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function getSalesProductReport(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function getSalesReconciliationReport(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
export function getSalesReturnReport(_params: any): Promise<ApiResponse<any>> { return Promise.resolve({ code: 200, message: 'stub', data: null } as any) }
